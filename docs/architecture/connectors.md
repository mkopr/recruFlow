...
[Connector architecture cleanup (US46)](ingestion.md) for the shared registry pattern, and
...
- [SOLID.Jobs](connectors/solid-jobs.md) — direct HTTP API (since BUG10); supports Fetch Scope (US47)
- [JustJoin.it](connectors/justjoinit.md) — direct HTTP API
- [NoFluffJobs](connectors/nofluffjobs.md) — direct HTTP API
- [Bulldogjob](connectors/bulldogjob.md) — sitemap + embedded `NEXT_DATA`; supports Fetch Scope (US47, `docs/adr/0027`)
- [Rocket Jobs](connectors/rocket-jobs.md) — sitemap + JSON-LD
- [Pracuj.pl](connectors/pracuj.md) — Playwright (Cloudflare-gated), listing-page enumeration; supports Fetch Scope (US47)
